            ...
            ?>
                    <div class="card-body">
                        <form action="?m=instruktur&s=update" method="post">
                            <div class="mb-3">
                                <input type="text" name="nis" value="<?=$r['nis']?>" class="form-control" placeholder="Nomor Induk Instruktur" required autofocus>
                            </div>
                            <div class="mb-3">
                                <input type="text" name="name" value="<?=$r['name']?>" class="form-control" placeholder="Nama Instruktur" required>
                            </div>
                            <div class="mb-3">
